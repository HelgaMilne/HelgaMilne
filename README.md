...
Люблю гулять по белому мху в сосновом бору<span> <img  width="30px" src="./src/images/forest_03.svg" alt="forest icon" /></span>  и кататься на лыжах по зимней равнине<span> <img  width="30px" src="./src/images/skiing.svg" alt="skier icon" /></span></p>
  <p>----------------------------------------------------------------------------</p>
          <ul > 
